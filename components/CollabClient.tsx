...
const COLLABS: Collab[] = [
  { id:1, brands:"Nike × Supreme", name:"Air Force 1 Low Supreme", year:2012, cat:"スニーカー", orig:15000, market:85000, rarity:"rare", icon:"AF1", isNew:false, desc:"SupremeのBox LogoとNike AF1の伝説的コラボ。赤・黒・白の3カラーが存在。", points:["Side Swooshがレザー製","Box Logo刺繍が高密度","靴底にSupremeロゴ"], searchKeyword:"シュプリーム ナイキ エアフォース1 コラボ" },
  { id:2, brands:"Nike × Off-White", name:"Air Max 97 Off-White", year:2017, cat:"スニーカー", orig:25000, market:120000, rarity:"very_rare", icon:"AM97", isNew:false, desc:"Virgil Ablohによる革命的デザイン。外部エアユニット露出が特徴。", points:["外部エアユニット露出","タグ&ジップタイ付属","半透明ソールに刻印"], searchKeyword:"オフホワイト ナイキ エアマックス97" },
  { id:3, brands:"Supreme × TNF", name:"Mountain Parka", year:2019, cat:"ジャケット", orig:65000, market:180000, rarity:"very_rare", icon:"TNF", isNew:false, desc:"毎シーズン話題を呼ぶ定番コラボ。初期ものは特に希少。", points:["TNF×Supreme Woven","フロントにSupreme刺繍","Gore-Tex素材（一部）"], searchKeyword:"シュプリーム ノースフェイス マウンテンパーカー" },
  { id:4, brands:"Supreme × LV", name:"Box Logo Tee", year:2017, cat:"Tシャツ", orig:50000, market:300000, rarity:"very_rare", icon:"LV", isNew:false, desc:"2017年パリコレで電撃発表。LVモノグラム×Box Logoの歴史的コラボ。", points:["LVショップのみ販売","レシート&証明書必須","偽物が非常に多い"], searchKeyword:"シュプリーム ルイヴィトン コラボ Tシャツ" },
  { id:5, brands:"Carhartt WIP × APC", name:"Detroit Jacket", year:2018, cat:"ジャケット", orig:38000, market:62000, rarity:"uncommon", icon:"CxA", isNew:false, desc:"A.P.CとのコラボDetroit Jacket。機能性×ミニマルデザインの融合。", points:["APCシグネチャーライニング","ダブルタグ仕様","フランスでも限定販売"], searchKeyword:"カーハート APC デトロイトジャケット コラボ" },
  { id:6, brands:"New Balance × ALD", name:"550", year:2024, cat:"スニーカー", orig:18700, market:55000, rarity:"rare", icon:"550", isNew:true, desc:"NYのセレクトショップALDとNBの人気コラボ。レトロなカラーパレットが◎", points:["ALDシグネチャーカラー","プレミアムレザー","ALD×NBダブルロゴ"], searchKeyword:"ニューバランス 550 エメレオンドレ ALD" },
  { id:7, brands:"Adidas × Wales Bonner", name:"Samba", year:2024, cat:"スニーカー", orig:22000, market:48000, rarity:"rare", icon:"WB", isNew:true, desc:"Wales BonnerとAdidasのSamba。ハンドクラフトレザーとアフリカンモチーフ。", points:["ハンドクラフトレザー","Wales Bonnerテープ","アフリカンモチーフ"], searchKeyword:"アディダス サンバ ウェールズボナー コラボ" },
  { id:8, brands:"Stone Island × Supreme", name:"Jacket", year:2020, cat:"ジャケット", orig:120000, market:280000, rarity:"very_rare", icon:"SI", isNew:false, desc:"ストリートの王とイタリア職人ブランドの夢のコラボ。", points:["左右異なるワッペン","Stone Island特殊染色","共同製造証明書付き"], searchKeyword:"ストーンアイランド シュプリーム ジャケット コラボ" },
  { id:9, brands:"Nike × Travis Scott", name:"Air Jordan 1", year:2019, cat:"スニーカー", orig:16500, market:150000, rarity:"very_rare", icon:"AJ1", isNew:false, desc:"逆向きSwooshとポケット付きが特徴的なAJ1コラボ。", points:["Swooshが逆向き","ポケット付き特殊仕様","隠しトラビスロゴ"], searchKeyword:"トラヴィス スコット エアジョーダン1 コラボ" },
];
